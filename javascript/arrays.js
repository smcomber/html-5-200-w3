...
function buildThumbnails()
{
  ...
  {
    output += '<img src="' + imageListA[i] + '"/>';//concatenation assignment
  }
  
  for(var j=0; j < imageListB.length; j++)
  {
    output += '<img src="' + imageListB[j] + '"/>';//concatenation assignment
  }
  for(var k=0; k < imageListC.length; k++)
  {
    output += '<img src="' + imageListC[k] + '"/>';//concatenation assignment
  }
